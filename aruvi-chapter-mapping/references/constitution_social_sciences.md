...
**Rule 6.** The system MUST assign Weight 1 (Present) ONLY IF the chapter contains at least one named structural element — a subsection, sidebar, or designated passage — whose primary subject is this competency and whose content requires the student to perform a cognitive operation on it, AND that element does not constitute a dedicated section or architecturally distinct activity block.
